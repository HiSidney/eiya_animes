...
document.getElementById('button_capitulo').addEventListener('click', function () {
    ...
    data_lancamento_capitulo = document.getElementById('data_lancamento_capitulo').value;
    ...
    'data_lancamento_temporada':data_lancamento_temporada,'video_capitulo':video_capitulo}
...
document.getElementById('button_temporada').addEventListener('click', function (){
    ...
    img_temporada = document.getElementById('img_temporada').value;
...
document.getElementById('button_genero').addEventListener('click', function () {
  ...
  axios.post(url_adm, Genero)
    .then(function(response){
    console.log(response.data);
    alert("Generô adicionado com sucesso!")
    })
    .catch(function (error) {
    // manipula erros da requisição
    console.error(error);
